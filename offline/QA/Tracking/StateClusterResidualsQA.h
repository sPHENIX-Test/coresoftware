...
class StateClusterResidualsQA : public SubsysReco
{
 public:
  ...
  /**
 * Specify the node name used to retrieve the track map.
 *
 * @param track_map_node_name Node name to look up the track map; defaults to "SvtxTrackMap" if not changed.
 */
