...
/**
 * @brief Decode Micromegas raw hits and populate the TRKR_HITSET with validated hits.
 *
 * Maps raw FEE/channel data to detector coordinates, filters permanently masked and hot channels,
 * applies calibration (pedestal and RMS) and amplitude thresholds, selects the peak sample per channel,
 * and inserts non-duplicated TrkrHitv2 entries into the TRKR_HITSET container.
 *
 * @param topNode Root PHCompositeNode containing the MicromegasRawHitContainer and TRKR_HITSET.
