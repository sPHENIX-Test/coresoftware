...
class CopyIODataNodes : public SubsysReco
{
 public:
  ...
  /**
   * Configure TowerInfo copying by specifying the source and destination node names and enabling the copy.
   * @param set_from_towerInfo_name Name of the source TowerInfo node to copy from.
   * @param set_to_towerInfo_name Name of the destination TowerInfo node to copy to.
   */
